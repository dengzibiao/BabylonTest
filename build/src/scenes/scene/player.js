...
var Player = /** @class */ (function (_super) {
    ...
    __decorate([
        tools_1.visibleInInspector("KeyMap", "Left Key", "q".charCodeAt(0))
    ...
    __decorate([
        tools_1.visibleInInspector("number", "Walk Speed", 1)
    ], Player.prototype, "_walkSpeed", void 0);
    __decorate([
        tools_1.visibleInInspector("number", "Run Speed", 2)
    ], Player.prototype, "_runSpeed", void 0);
    __decorate([
        tools_1.visibleInInspector("number", "Transition Speed", 1)
    ], Player.prototype, "_transitionSpeed", void 0);
    __decorate([
        tools_1.visibleInInspector("number", "Animation Speed", 1)
    ], Player.prototype, "_animationSpeed", void 0);
    __decorate([
        tools_1.fromScene("playerCamera")
    ], Player.prototype, "_camera", void 0);
    __decorate([
        tools_1.onKeyboardEvent([32], core_1.KeyboardEventTypes.KEYUP)
    ], Player.prototype, "_jump", null);
    __decorate([
        tools_1.onKeyboardEvent([], core_1.KeyboardEventTypes.KEYDOWN)
    ], Player.prototype, "_onKeyboardDown", null);
    __decorate([
        tools_1.onKeyboardEvent([], core_1.KeyboardEventTypes.KEYUP)
