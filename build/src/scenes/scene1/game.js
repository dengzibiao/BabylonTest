...
var GameComponent = /** @class */ (function (_super) {
    ...
    GameComponent.prototype.onInitialize = function () {
        ...
        this._gameMessageControl = new gui_1.TextBlock("gameTips", "这是第二个场景");
        this._gameMessageControl.color = "white";
        this._gameMessageControl.textHorizontalAlignment = gui_1.Control.HORIZONTAL_ALIGNMENT_CENTER;
        this._gameMessageControl.textVerticalAlignment = gui_1.Control.VERTICAL_ALIGNMENT_TOP;
